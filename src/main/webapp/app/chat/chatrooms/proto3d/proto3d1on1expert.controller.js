(function() {
    ...
    Proto3D1on1ExpertController.$inject = ['$rootScope','$cookies', '$http','JhiTrackerService', 'SdpService'];

    function Proto3D1on1ExpertController($rootScope, $cookies, $http, JhiTrackerService, SdpService) {
