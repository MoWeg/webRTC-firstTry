(function() {
    ...
    angular
        ...
        .controller('Motion2OrientationController', Motion2OrientationController);

    Motion2OrientationController.$inject = ['OrientationCalculator'];

    function Motion2OrientationController(OrientationCalculator) {
      var vm = this;
      ...
      function deviceMotionHandler(event){
        if(needsCalibration){
          ...
          //var orientationInfo = OrientationCalculator.calculateOrientation(event.rotationRate, null);
          //setOrientationInfo(orientationInfo);
