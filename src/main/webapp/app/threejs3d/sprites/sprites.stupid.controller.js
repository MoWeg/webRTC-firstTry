    ...
    function SpritesController() {
      ...
      vm.switchMethod = console.log("switch");;
			...
			function init() {
				...
				var mapA = textureLoader.load( "content/images/logo-jhipster.png", createHUDSprites );
				var mapB = textureLoader.load( "content/images/logo-jhipster.png" );
				mapC = textureLoader.load( "content/images/logo-jhipster.png" );
